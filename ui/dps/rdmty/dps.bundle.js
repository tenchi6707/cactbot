...
Object.defineProperty(Header.prototype, 'render', {
  ...
  value: function () {
    ...
    return React.createElement('div', {
      ...
      className: 'value ff-text'
    }, formatNumber(encounter.encdps))), // TODO: encounter['crithit%'] appears to always be zero.
...
function onOverlayDataUpdate(e) {
  ...
  React.render(React.createElement(DamageMeter, {
    parseData: e.detail
  }), container); // console.log('rendered in ' + (+new Date() - start) + 'ms');
}
...
user_config/* default.getUserConfigLocation */.Z.getUserConfigLocation('rdmty', Options, e => {
