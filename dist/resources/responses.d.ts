...
export declare const Responses: {
    ...
    readonly tankBusterSwap: (busterSev?: "info" | "alert" | "alarm" | undefined, swapSev?: "info" | "alert" | "alarm" | undefined) => (_data: Data, _matches: unknown, output: Output) => ResponseOutput<import("../types/trigger").Matches<"target" | "sourceId" | "source" | "targetId">>;
    ...
    readonly knockbackOn: (targetSev?: "info" | "alert" | "alarm" | undefined, otherSev?: "info" | "alert" | "alarm" | undefined) => (_data: Data, _matches: unknown, output: Output) => ResponseOutput<import("../types/trigger").Matches<"target" | "sourceId" | "source" | "targetId">>;
    ...
    readonly preyOn: (targetSev?: "info" | "alert" | "alarm" | undefined, otherSev?: "info" | "alert" | "alarm" | undefined) => (_data: Data, _matches: unknown, output: Output) => ResponseOutput<import("../types/trigger").Matches<"target" | "sourceId" | "source" | "targetId">>;
