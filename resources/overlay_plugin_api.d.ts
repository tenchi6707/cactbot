...
declare const processEvent: <T extends "onLogEvent" | "CombatData" | "LogLine" | "ChangeZone" | "ChangePrimaryPlayer" | "FileChanged" | "OnlineStatusChanged" | "PartyChanged" | "BroadcastMessage" | "EnmityTargetData" | "onForceReload" | "onGameExistsEvent" | "onGameActiveChangedEvent" | "onImportLogEvent" | "onInCombatChangedEvent" | "onZoneChangedEvent" | "onFateEvent" | "onCEEvent" | "onPlayerDied" | "onPartyWipe" | "onPlayerChangedEvent" | "onUserFileChanged">(msg: Parameters<EventMap[T]>[0]) => void;
export declare const dispatchOverlayEvent: <T extends "onLogEvent" | "CombatData" | "LogLine" | "ChangeZone" | "ChangePrimaryPlayer" | "FileChanged" | "OnlineStatusChanged" | "PartyChanged" | "BroadcastMessage" | "EnmityTargetData" | "onForceReload" | "onGameExistsEvent" | "onGameActiveChangedEvent" | "onImportLogEvent" | "onInCombatChangedEvent" | "onZoneChangedEvent" | "onFateEvent" | "onCEEvent" | "onPlayerDied" | "onPartyWipe" | "onPlayerChangedEvent" | "onUserFileChanged">(msg: Parameters<EventMap[T]>[0]) => void;
